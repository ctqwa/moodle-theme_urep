...
// in version.php and lang/en/theme_urep.php as well.

$THEME->doctype = 'html5';
$THEME->yuicssmodules = array();
$THEME->parents = array('bootstrapbase');
$THEME->sheets = array('slides', 'categories', 'font-awesome.min', 'urep', 'alternative1', 'alternative2', 'alternative3', 'settings', 'editicons', 'fonts', 'urep-custom');
...
$THEME->layouts = array(
    ...
    'incourse' => array(
        'file' => 'incourse_with_heading.php',
        'regions' => array('side-pre', 'footer-left', 'footer-middle', 'footer-right'),
        'defaultregion' => 'side-pre',
    ),
...
$THEME->csspostprocess = 'theme_urep_process_css';
