YUI.add('moodle-theme_urep-coloursswitcher', function(Y) {
 ...
 * Initialise this class by calling M.theme_urep.init
 */
...
ColoursSwitcher.prototype = {
    ...
    initializer : function(config) {
        ...
        for (i in SCHEMES) {
            ...
            if (Y.one(document.body).hasClass('urep-colours-' + s)) {
                this.set('scheme', s);
            }
    ...
    /**
     * Sets the colour being used for the urep theme
...
M.theme_urep = M.theme_urep || {};
// Initialisation function for the colours scheme switcher
M.theme_urep.initColoursSwitcher = function(cfg) {
