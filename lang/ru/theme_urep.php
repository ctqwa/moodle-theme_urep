...
/* Core */
$string['configtitle'] = 'Urep';
$string['pluginname'] = 'Urep';
$string['choosereadme'] = '
<div class="clearfix">
<div class="well">
<h2>Clean</h2>
...
<div class="well">
<h3>О теме Urep</h3>
<p>Urep это измененная Moodle bootstrap тема, она наследует стили и оформление от родительской темы.</p>
<h3>Родители</h3>
...
$string['fontselect'] = 'Выбор шрифтов';
$string['fontselectdesc'] = 'Выберите из списка доступную комбинацию шрифтов. Вы можете, если хотите, отключить шрифты Google.';
...
$string['frontpageblocks'] = 'Размещение блоков на главной странице';
$string['frontpageblocksdesc'] = 'Здесь вы можете определить, как выровнить блоки на главной странице.';
$string['left'] = 'Слева';
$string['right'] = 'Справа';
...
$string['dontdisplay'] = 'Не показывать';
...
$string['slidecolors'] = 'Цвета слайд-шоу';
$string['slidecolorsdesc'] = 'Изменение цвета на слайд-шоу';

$string['footercolors'] = 'Цвета нижнего колонтитула';
$string['footercolorsdesc'] = 'Измените цвета нижнего колонтитула';
...
$string['frontpagemiddleblocks'] = 'Включить центральные блоки на главной странице';
$string['frontpagemiddleblocksdesc'] = 'Если опция включена на главной странице будудт отображены под рекламными блоками 3 новых блока';
...
$string['toggleslideshow'] = 'Вкл./выкл. слайд-шоу';
$string['toggleslideshowdesc'] = 'Выберите, если хотите скрыть или показать слайд-шоу.';
...
$string['slidecolor'] = 'Цвет текста на слайде';
$string['slidecolordesc'] = 'Определяет каким цветом должен быть напечатан основной текст';
$string['slideheadercolor'] = 'Цвет заголовка слайда';
