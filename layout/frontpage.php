...
<head>
    ...
    <noscript>
			<link rel="stylesheet" type="text/css" href="<?php echo $CFG->wwwroot;?>/theme/urep/style/nojs.css" />
	</noscript>
...
<!-- End Frontpage Content -->
	...
	<div class="hidden-blocks">
    	<div class="row-fluid">
        	<h4><?php echo get_string('visibleadminonly', 'theme_urep') ?></h4>
            <?php
                echo $OUTPUT->urepblocks('hidden-dock');
            ?>
    	</div>
	</div>
	<?php } ?>
